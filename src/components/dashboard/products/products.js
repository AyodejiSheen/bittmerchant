          ...
          {/* upper section */}
            <div className="flex items-center justify-between pb-10 border-b">
                ...
                <div className="flex items-center space-x-8 font-medium text-sm">
                  ...
                  <div>
                    <button className="md:hidden border px-4  rounded-md" onClick={() => handledrop('action')}> <i className=" text-2xl fa-solid fa-ellipsis "></i> </button>
    ...
    {/* table begin */}
        ...
        <section className="shadow bg-white px-3 md:px-6 pt-2 pb-5 text-sm ">
            ...
            <div className=" mt-5">
              <div hidden={active !== 'tab1'} className="">
                <div>
                  ...
                  <input type="search" placeholder="Filter products" className="rounded-md text-xs md:text-xs xl:text-sm w-full md:w-1/3 lg:w-1/4 xl:w-80 2xl:w-1/2"/>
                  <div className="flex flex-wrap  justify-between">
                      ...
                      <div>
                        <div className="hidden md:inline-block border py-2.5  px-4 md:px-3 2xl:px-4 text-xs xl:text-sm cursor-pointer hover:bg-slate-50 transition-all" onClick={() => handledrop('tagged')}>Tagged with  <i className="ml-3 fa-solid fa-caret-down"></i> </div>
                          ...
                          <input type="text" className="border w-full rounded-md border-slate-300 text-xs xl:text-sm"/>
                          <button className="font-light bg-indigo-700 text-white px-3 rounded py-1">Clear</button>
                      </div>                       
                      </div>
            ...
            <div className={` backdrop-blur-lg w-full overflow-y-scroll md:w-80 xl:w-96 md:h-full bg-white/30 mt-5 min-h-screen  inset-y-0 right-0 top-12  shadow-2xl transform fixed transition duration-300 ease-in-out z-40 ${ acc ? "translate-x-0" : "translate-x-full"}`}>
                  ...
                  <div className="px-10 items-center space-x-8 border-b flex flex-wrap justify-between">
                    <p className="text-lg ">More filters</p>
                    <button className="text-lg border px-8 py-2" onClick={handleAcc}> x </button>
                  </div>


                  <div className="bg-white/30 h-1/2 fixed overflow-y-scroll">
            ...
            <div className="px-10 space-x-8 border-t mt-96 flex flex-wrap justify-between">
                   <button className="border bg-slate-100 px-4 py-2.5">Clear all filters</button>
                  <button className="bg-emerald-700 text-white px-7  rounded-md py-2.5">Done</button>
            </div>
